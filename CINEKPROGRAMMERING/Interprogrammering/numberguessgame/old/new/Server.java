...
public class Server {
    ...
    public static String readFullbody(BufferedReader in)throws IOException{
        int cha;
        String fullbody="";
        while((cha=in.read())!=-1){
            fullbody+=(char)cha;
        ...
        try (ServerSocket serverSocket = new ServerSocket(this.port)) {
            ...
            while (true) {
                ...
                try (Socket socket = serverSocket.accept();
                    ...
                    Boolean activate=in.ready();
                    String fullbody=readFullbody(in);


                    Pattern pGET = Pattern.compile("GET", Pattern.CASE_INSENSITIVE);
                    Pattern pPOST = Pattern.compile("POST", Pattern.CASE_INSENSITIVE);
                    Matcher mGET = pGET.matcher(fullbody);
                    Matcher mPOST = pGET.matcher(fullbody);
